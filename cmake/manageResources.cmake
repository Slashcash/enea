...
if(NOT ${STATUS_CODE} EQUAL 0)
  message(FATAL_ERROR "Failed to download CMakeRC")
endif()
...
function(add_resource)
  ...
  file(DOWNLOAD "${RESOURCE_URL}/${RESOURCE_NAME}"
       "${RESOURCE_DOWNLOAD_LOCATION}/${RESOURCE_NAME}" STATUS DOWNLOAD_STATUS)

  list(GET DOWNLOAD_STATUS 0 STATUS_CODE)
  if(NOT ${STATUS_CODE} EQUAL 0)
    message(FATAL_ERROR "Failed to download ${RESOURCE_URL}/${RESOURCE_NAME}")
  endif()
