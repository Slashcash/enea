...
class Toolchain(ConanFile):
    ...
    def package(self):
        ...
        cmake_c_new_flags = "-mfpu=neon -L" + external_folder + " -Wl,-rpath-link," + external_folder
        ...
        cmake_cxx_new_flags = "-mfpu=neon -L" + external_folder + " -Wl,-rpath-link," + external_folder
