...
const Input::Mapping Input::Device::DEFAULT_KEYBOARD_MAPPING{
    {
        {Emulator::Command::p1_up, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "up"}},
        {Emulator::Command::p1_down, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "down"}},
        {Emulator::Command::p1_left, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "left"}},
        {Emulator::Command::p1_right, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "right"}},
        {Emulator::Command::p1_button1, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "7_pad"}},
        {Emulator::Command::p1_button2, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "8_pad"}},
        {Emulator::Command::p1_button3, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "9_pad"}},
        {Emulator::Command::p1_button4, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "4_pad"}},
        {Emulator::Command::p1_button5, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "5_pad"}},
        {Emulator::Command::p1_button6, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "6_pad"}},
