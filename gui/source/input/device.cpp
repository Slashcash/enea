...
const Input::Mapping Input::Device::DEFAULT_KEYBOARD_MAPPING{
    {
        ...
        {Emulator::Command::p2_up, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "w"}},
        {Emulator::Command::p2_down, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "s"}},
        {Emulator::Command::p2_left, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "a"}},
        {Emulator::Command::p2_right, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "d"}},
        {Emulator::Command::p2_button1, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "i"}},
        {Emulator::Command::p2_button2, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "o"}},
        {Emulator::Command::p2_button3, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "p"}},
        {Emulator::Command::p2_button4, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "j"}},
        {Emulator::Command::p2_button5, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "k"}},
        {Emulator::Command::p2_button6, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "l"}},
        {Emulator::Command::coin2, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "3"}},
        {Emulator::Command::start2, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "1"}},
        ...
        {Emulator::Command::p4_up, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "w"}},
        {Emulator::Command::p4_down, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "s"}},
        {Emulator::Command::p4_left, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "a"}},
        {Emulator::Command::p4_right, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "d"}},
        {Emulator::Command::p4_button1, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "i"}},
        {Emulator::Command::p4_button2, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "o"}},
        {Emulator::Command::p4_button3, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "p"}},
        {Emulator::Command::p4_button4, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "j"}},
        {Emulator::Command::p4_button5, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "k"}},
        {Emulator::Command::p4_button6, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "l"}},
        {Emulator::Command::coin4, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "3"}},
        {Emulator::Command::start4, Input::Emulator::Button{Input::Emulator::Button::Type::keyboard, "1"}},
